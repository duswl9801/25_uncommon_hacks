...
class Settings(BaseSettings):
    ...
    app_name: str = "Game Catcher"
    TEST_MODE: bool = False

    ALLOW_SITE = ["*"]
    TRUSTED_HOSTS = ["*"]
    JWT_ALGORITHM = "HS256"
    JWT_SECRET_KEY = os.getenv("JWT_SECRET", "gamecatcher-secret")
...
class DevSettings(Settings):
    DB_URL = "mysql+pymysql://root:root@localhost:3306/gamecatcher?charset=utf8mb4"
    DB_POOL_SIZE = 5
    DB_MAX_OVERFLOW = 10
