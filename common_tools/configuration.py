...
class Configuration:
    def __init__(self, config_data, key_order=None, strict_mode=False):
    ...
    @staticmethod
    def from_file(filename, strict_mode=False):
        ...
        return Configuration(config_data, key_order, strict_mode)
